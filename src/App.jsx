  ...
  return (
    <div className='px-6'>
      ...
      <div className='flex bg-slate-900 py-4 rounded-t-lg '>
        <div className='menu-hover px-6'><button onClick={() => handleClick(null)}>Inicio</button></div>
        <div className='menu-hover px-6'><button onClick={() => handleClick(1)}>vestido rojo</button></div>
        <div className='menu-hover px-6'><button onClick={() => handleClick(2)}>vestido verde</button></div>
        <div className='menu-hover px-6'><button onClick={() => handleClick(3)}>comparacion</button></div>
      </div>
      {
      ...
      {
        click === 2 && <ContentBox title='Vestido Verde' content={contenido2} src='https://cdn0.matrimonios.cl/article-dress/0230/original/1280/jpg/m450320.jpeg' alt='vestido verde' h='200' w='300' />
      }
      {
